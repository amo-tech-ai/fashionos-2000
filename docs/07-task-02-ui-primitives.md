...
## 1. Context
We implement the "Atelier" visual language. High contrast, serif headers (Playfair Display/Cormorant Garamond), functional sans-serif body (Inter), and specific accent colors.
...
- **Fonts:**
  - Serif: 'Cormorant Garamond' (or 'Playfair Display')
  - Sans: 'Inter'
...
3. UPDATE APP
=========================================
- Apply `bg-fashion-cream` (or similar brand color) to the body tag in `index.html`.
...
- [ ] Font family is correct for headings.
- [ ] Cards have the correct corner radius.