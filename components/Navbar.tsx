...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-white/90 backdrop-blur-md py-4 border-b border-gray-100' : 'bg-transparent py-8'}`}>
      <div className="max-w-[1320px] mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-12 text-xs font-medium tracking-widest uppercase items-center">
          <div className="relative group">
            <Link to="/services/photography" className="hover:text-gray-500 transition-colors">Services</Link>
          ...
          <a href="#" className="hover:text-gray-500 transition-colors">Directory</a>
          <a href="#" className="hover:text-gray-500 transition-colors">Marketplace</a>
        </div>

        <div className="hidden md:flex items-center space-x-6">
           <a href="#" className="text-xs font-medium tracking-widest uppercase border-b border-transparent hover:border-black transition-colors">Log In</a>
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="absolute top-full left-0 w-full bg-white border-b border-gray-100 md:hidden flex flex-col items-center py-8 space-y-6 animate-fade-in shadow-lg">
          ...
          <a href="#" className="text-sm tracking-widest uppercase">Directory</a>
          <a href="#" className="text-sm tracking-widest uppercase">Marketplace</a>
